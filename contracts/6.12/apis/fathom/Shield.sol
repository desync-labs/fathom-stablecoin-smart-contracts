...
contract Shield {
    ...
    constructor(IFairLaunchV1 _fairLaunchV1) public {
    ...
    function mintWarchest(address _to, uint256 _amount) external {
        require(mintCount + (_amount) <= mintLimit, "Shield::mintWarchest:: mint exceeded mintLimit");
        fairLaunchV1.manualMint(_to, _amount);
        mintCount = mintCount + (_amount);
    ...
    function addPool(
        ...
        emit AddPool(fairLaunchV1.poolLength() - (1), _allocPoint, _stakeToken);
    }
