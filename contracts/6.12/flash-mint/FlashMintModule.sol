...
contract FlashMintModule is IERC3156FlashLender, IBookKeeperFlashLender {
    ...
    // --- Init ---
    constructor(address _stablecoinAdapter, address _systemDebtEngine) public {
    ...
    function setMax(uint256 _data) external {
    ...
    /// @dev access: OWNER_ROLE
    function setFeeRate(uint256 _data) external {
        feeRate = _data;
    ...
    /// @dev access: OWNER_ROLE
    function refreshApproval() external lock {
