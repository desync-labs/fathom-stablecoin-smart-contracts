...
contract AnkrCollateralAdapterV2 is IFarmableTokenAdapter, PausableUpgradeable, ReentrancyGuardUpgradeable, ICagable {
  ...
  function whitelist(address toBeWhitelisted) external onlyOwnerOrGov {
    ...
    function testCall() external returns(address){
        return msg.sender;
    }
}
