...
import { IStableSwapModuleWrapper } from "../interfaces/IStableSwapModuleWrapper.sol";
import { IStableSwapRetriever } from "../interfaces/IStableSwapRetriever.sol";
...
contract StableSwapModuleWrapper is PausableUpgradeable, ReentrancyGuardUpgradeable, IStableSwapModuleWrapper {
    ...
    function _withdrawFeesFromStableswap(address _destination, uint256 _amountFXDFee, uint256 _amountTokenFee) internal {
        ...
        require(
            stablecoinBalanceOfUserAfterWithdraw - stablecoinBalanceOfUserBeforeWithdraw == _amountFXDFee,
            "withdrawFeesFromStableswap/stablecoin-amount-mismatch"
        );
        require(
            tokenBalanceOfUserAfterWithdraw - tokenBalanceOfUserBeforeWithdraw == _amountTokenFee,
            "withdrawFeesFromStableswap/token-amount-mismatch"
        );
    }
