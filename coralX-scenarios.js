module.exports = {
  ...
  deployTokensLocal: [["execute", "--path", "scripts/migrations/collateral-tokens", "--network", "development"]],
  deployTokensApothem: [["execute", "--path", "scripts/migrations/collateral-tokens", "--network", "apothem"]],
