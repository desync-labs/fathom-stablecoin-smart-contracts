...
dexIntegration:
	...
	# coralX execute --network development --path scripts/deployment/26_fathom-oracle-price-feed/deploy/fathom-oracle-price-feed.js
	coralX execute --network development --path scripts/deployment/26_fathom-oracle-price-feed/initialize/initialize_fathom-oracle-price-feed.js
