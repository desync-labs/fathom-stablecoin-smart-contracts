...
# ankrCollateralAdapter
	coralX execute --network apothem --path scripts/deployment/35_ankr-collateral-adapter/deploy/ankr-collateral-adapter.js
...
# deploy MockaXDCc
	coralX execute --network apothem --path scripts/deployment/33_mock-aXDCc/deploy/mock-aXDCc.js
# deploy MockXDCStakingPool
	coralX execute --network apothem --path scripts/deployment/34_mock-ankrStakingPool/deploy/mock-ankrStakingPool.js
# init ankrCollateralAdapter
	coralX execute --network apothem --path scripts/deployment/35_ankr-collateral-adapter/initialize/initialize_ankr-collateral-adapter.js
...
# whiteList ankrCollateralAdapter to bookKeeper
	# coralX execute --network apothem --path scripts/deployment/2_book-keeper/config/whitelist-collateral-token-adapter-ankr.js
...
#better be tested locally
	...
	coralX execute --network apothem --path scripts/deployment/15_simple-price-feed/config/config_simple-price-feed-WXDC.js
	# Second set price to update priceWithSafetyMargin in PriceOracle for WXDC
	coralX execute --network apothem --path scripts/deployment/7_price-oracle/config/setPriceXDC.js
