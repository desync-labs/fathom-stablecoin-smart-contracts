  ...
  describe("#collect", () => {
    context("when call collect", async () => {
      it("should be rate to ~ 1%", async () => {
        ...
        // Set expectations
        const expectedCollateralPoolId = formatBytes32String("WXDC");
        ...
        await stabilityFeeCollectorAsAlice.collect(formatBytes32String("WXDC"));
  ...
  describe("#unpause", () => {
    ...
    context("when unpause contract", () => {
      it("should be success", async () => {
        ...
        await stabilityFeeCollector.collect(formatBytes32String("WXDC"));
      });
    });
  });
});
