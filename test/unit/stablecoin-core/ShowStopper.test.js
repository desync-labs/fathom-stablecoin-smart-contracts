      ...
      context("pool is inactive", () => {
        ...
        context("and debtShare is 0 and lockedCollateral is 1 ray", () => {
          it("should be success", async () => {
            ...
            mockedBookKeeper.positions.whenCalledWith(formatBytes32String("XDC"), DeployerAddress).returns([WeiPerRay, BigNumber.from("0")]);
            mockedBookKeeper.confiscatePosition
              .whenCalledWith(formatBytes32String("XDC"), DeployerAddress, DeployerAddress, mockedSystemDebtEngine.address, WeiPerRay.mul("-1"), 0)
              .returns();
        ...
        context("and debtShare is 0 and lockedCollateral is 1 ray, the caller is not the owner of the address but has access to", () => {
          it("should be success", async () => {
            ...
            mockedBookKeeper.positions.whenCalledWith(formatBytes32String("XDC"), AliceAddress).returns([WeiPerRay, BigNumber.from("0")]);
            mockedBookKeeper.confiscatePosition
              .whenCalledWith(formatBytes32String("XDC"), AliceAddress, AliceAddress, mockedSystemDebtEngine.address, WeiPerRay.mul("-1"), 0)
              .returns();
