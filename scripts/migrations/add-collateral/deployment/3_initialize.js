...
module.exports = async function (deployer) {
  ...
  const promises = [
    ...
    collateralTokenAdapter.initialize(bookKeeper.address, poolId, config.tokenAddress, proxyWalletFactory.address),
    delayFathomOraclePriceFeed.initialize(dexPriceOracle.address, config.tokenAddress, addresses.USD, accessControlConfig.address, poolId),
  ];
