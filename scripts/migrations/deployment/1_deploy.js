...
module.exports =  async function(deployer) {
  let promises = [
      ...
      deployer.deploy(GetPositionsV2, { gas: 3050000 }),
      deployer.deploy(GetPositionsBot, { gas: 3050000 }),
      deployer.deploy(FathomStats, { gas: 3050000 }),
      ...
      deployer.deploy(FathomProxyFactory, { gas: 3050000 }),
      deployer.deploy(FathomProxyAdmin, { gas: 3050000 }),
      deployer.deploy(FathomOraclePriceFeedFactory, { gas: 3050000 }),
  ];

  await Promise.all(promises);

  await deployer.deploy(FairLaunch, FathomToken.address, Deployer, parseEther("100"), 0, 0, 0, { gas: 4050000 }),
  await deployer.deploy(Shield, Deployer, FairLaunch.address, { gas: 4050000 })
};