...
module.exports = async function (deployer) {
  ...
  const promises1 = [
    MockCollateralTokenAdapter.initialize(bookKeeper.address, pools.WXDC, addresses.WXDC, positionManager.address, proxyWalletFactory.address),
  ...
  const promises2 = [MockCollateralTokenAdapter.setVault(MockVault.address)];
