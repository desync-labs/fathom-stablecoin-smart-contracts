...
const CLOSE_FACTOR_BPS = BigNumber.from(2500)   // <- 0.5
const LIQUIDATOR_INCENTIVE_BPS = BigNumber.from(10500)  // <- 1.05
const TREASURY_FEE_BPS = BigNumber.from(8000) // <- 0.5 50%
...
module.exports = async function(deployer) {
  ...
  console.log(">> Initializing collateral-pool-config with XDC");
  ...
  await collateralPoolConfig.initCollateralPool(
    ...
    stablecoinAddress.ankrCollateralAdapter,   //<-_adapter
