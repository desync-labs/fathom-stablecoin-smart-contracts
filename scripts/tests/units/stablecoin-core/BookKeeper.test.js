...
describe("BookKeeper", () => {
  ...
  beforeEach(async () => {
    ...
    bookKeeperAsAlice = getContract("BookKeeper", AliceAddress)
    bookKeeperAsBob = getContract("BookKeeper", BobAddress)

    await bookKeeper.setCollateralPoolConfig(mockedCollateralPoolConfig.address);
    await bookKeeper.setAccessControlConfig(mockedAccessControlConfig.address);
  })
