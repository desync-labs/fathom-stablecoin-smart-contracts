...
describe("PriceOracle", () => {
  ...
  beforeEach(async () => {
    ({ priceOracle, priceOracleAsAlice, mockedBookKeeper, mockedPriceFeed, mockedAccessControlConfig, mockedCollateralPoolConfig } =
    ...
    context("when price from price feed is 1", () => {
      context("and price with safety margin is 0", () => {
        it("should be success", async () => {
          ...
          await mockedBookKeeper.mock.collateralPoolConfig.returns(mockedCollateralPoolConfig.address);
          await mockedCollateralPoolConfig.mock.setPriceWithSafetyMargin.withArgs(formatBytes32String("WXDC"), BigNumber.from("0")).returns();
    ...
    context("when price from price feed is 1", () => {
      context("and price with safety margin is 0", () => {
        it("should be success", async () => {
          ...
          await mockedBookKeeper.mock.collateralPoolConfig.returns(mockedCollateralPoolConfig.address);
          await mockedCollateralPoolConfig.mock.setPriceWithSafetyMargin.withArgs(formatBytes32String("WXDC"), BigNumber.from("0")).returns();
          await mockedCollateralPoolConfig.mock.setPriceWithSafetyMargin.withArgs(formatBytes32String("JEJU"), BigNumber.from("0")).returns();
