...
describe("StabilityFeeCollector", () => {
  ...
  beforeEach(async () => {
    ({ stabilityFeeCollector, stabilityFeeCollectorAsAlice, mockedBookKeeper, mockedCollateralPoolConfig, mockedAccessControlConfig } =
  ...
  describe("#collect", () => {
    context("when call collect", async () => {
      it("should be rate to ~ 1%", async () => {
        ...
        await mockedCollateralPoolConfig.mock.getStabilityFeeRate.returns(BigNumber.from("1000000000315522921573372069"));
        ...
        await mockedBookKeeper.mock.accrueStabilityFee
          .withArgs(expectedCollateralPoolId, expectedStabilityFeeRecipient, expectedDebtAccumulatedRate)
          .returns();
