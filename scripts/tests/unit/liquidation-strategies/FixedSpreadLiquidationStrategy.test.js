    ...
    context("when feedprice is invalid", () => {
      context("when priceFeed marked price as not ok", () => {
        it("should be revert", async () => {
          ...
          await mockedPriceFeed.mock.peekPrice.returns(formatBytes32BigNumber(BigNumber.from("700000000000")), false);
        ...
        context("and debtAccumulatedRate == 2", () => {
          it("should be success", async () => {
            ...
            await mockedBookKeeper.mock.confiscatePosition
              ...
              .returns();
            await mockedBookKeeper.mock.moveCollateral
              .withArgs(formatBytes32String("WXDC"), fixedSpreadLiquidationStrategy.address, DeployerAddress, ethers.utils.parseEther("2.0375"))
              .returns();
            await mockedBookKeeper.mock.moveCollateral
              .withArgs(
                formatBytes32String("WXDC"),
        ...
        context("and debtAccumulatedRate == 12345", () => {
          it("should be success", async () => {
            ...
            await mockedBookKeeper.mock.confiscatePosition
              ...
              .returns();
            await mockedBookKeeper.mock.moveCollateral
              .withArgs(formatBytes32String("WXDC"), fixedSpreadLiquidationStrategy.address, DeployerAddress, ethers.utils.parseEther("1586.1781875"))
              .returns();
            await mockedBookKeeper.mock.moveCollateral
              .withArgs(
                formatBytes32String("WXDC"),
            ...
            await mockedBookKeeper.mock.moveStablecoin.returns();
            await mockedPriceOracle.mock.stableCoinReferencePrice.returns(UnitHelpers.WeiPerRay);
            await mockedPriceFeed.mock.peekPrice.returns(formatBytes32BigNumber(UnitHelpers.WeiPerWad.mul(2)), true);
