...
async function main() {
    ...
    // Approve 10,000 
   await fathomStablecoin.approve(stablecoinAddress.stableSwapModule, WeiPerWad.mul(3000000));
   ...
   await stableSwapModule.swapStablecoinToToken(deployerAddress, WeiPerWad.mul(2500000));

   // it is important to note that approved amount is bigger than stableSwapCoinToToken amount;
   // it is needed for fee payment.
