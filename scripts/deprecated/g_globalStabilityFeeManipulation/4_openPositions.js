...
let rawdata2 = fs.readFileSync('./scripts/g_globalStabilityFeeManipulation/cupcakes/3_proxyWalletAddresses.json');
...
async function main() {
    ...
    fs.writeFileSync('./scripts/g_globalStabilityFeeManipulation/cupcakes/4_positionHandlerAddresses.json', data);
