...
let rawdata2 = fs.readFileSync('./scripts/m_depositColateral/cupcakes/2_proxyWalletAddresses.json');
...
async function main() {
    ...
    fs.writeFileSync('./scripts/m_depositColateral/cupcakes/3_positionHandlerAddresses.json', data);
