...
const WXDCArtifact = require("../../artifacts/contracts/tests/mocks/BEP20.sol/BEP20.json");
...
async function main() {
    ...
    fs.writeFileSync('./scripts/a_liquidationScenario/cupcakes/3_positionHandlerAddresses.json', data);
