...
const BPS = BigNumber.from(10000) // <- 1.00
...
async function main() {
    ...
    await collateralPoolConfig.initCollateralPool(
        ...
        AddressZero    //<-_strategy .. It is later defined
    )
    ...
    fs.writeFileSync('./scripts/a_liquidationScenario/cupcakes/1_collateralPoolConfig.json', data);
}
