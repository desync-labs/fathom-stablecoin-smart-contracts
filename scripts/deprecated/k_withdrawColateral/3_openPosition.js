...
let rawdata2 = fs.readFileSync('./scripts/k_withdrawColateral/cupcakes/2_proxyWalletAddresses.json');
...
async function main() {
    ...
    fs.writeFileSync('./scripts/k_withdrawColateral/cupcakes/3_positionHandlerAddresses.json', data);
