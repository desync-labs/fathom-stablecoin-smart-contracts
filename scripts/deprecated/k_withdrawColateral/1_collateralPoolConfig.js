...
async function main() {
    ...
    await collateralPoolConfig.initCollateralPool(
        ...
        BigNumber.from("1000000000158153903837946258"),    //<-_stabilityFeeRate = 0.5%
    ...
    fs.writeFileSync('./scripts/k_withdrawColateral/cupcakes/1_collateralPoolConfig.json', data);
