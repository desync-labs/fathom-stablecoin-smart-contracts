...
async function main() {
    ...
    console.log("SystemDebtEngine's stablecoin balance in bookKeeper: " + await bookKeeper.stablecoin(systemDebtEngineJSON.address));
    console.log("DebtAccumulatedRate before collect: " + await collateralPoolConfig.getDebtAccumulatedRate(COLLATERAL_POOL_ID));
