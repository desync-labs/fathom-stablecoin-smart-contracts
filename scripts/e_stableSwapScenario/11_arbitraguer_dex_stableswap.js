...
const walletArbitrageur = new hre.ethers.Wallet(privateKey3,provider);
...
// Copyright Fathom 2022
        ...
        //Mint some stablecoin to Arbitrageur
        // console.log("Minting 1000 USDT to Arbitrageur...")
        // USDT.connect(walletDeployer);
        // await USDT.mint(walletArbitrageur.address, parseEther("1000"))
        
        USDT.connect(walletArbitrageur);
        await USDT.approve(RouterAdderess, parseEther("1000"));

     console.log('Buying cheaper stablecoin from DEX...')
     await swapTokens(USDT.address,fathomStablecoin.address,100,walletArbitrageur)
}
