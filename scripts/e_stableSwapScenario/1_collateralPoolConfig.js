...
async function main() {
        // const BookKeeperArtifactAbi = BookKeeperArtifact.abi;
        // const CollateralPoolConfigArtifactAbi = CollateralPoolConfigArtifact.abi;
    ...
    console.log(`Collatral pool initialized...`)

    let data = JSON.stringify(params);
    fs.writeFileSync('./scripts/e_stableSwapScenario/cupcakes/1_collateralPoolConfig.json', data);
}
