...
let rawdata2 = fs.readFileSync('./scripts/e_stableSwapScenario/cupcakes/2_proxyWalletAddresses.json');
...
async function main() {
    ...
    // WXDC as signers
    const USDTAbi = WXDCArtifact.abi;
    const WXDCAsAlice = new hre.ethers.Contract(USDT.address, USDTAbi, walletAlice);
    ...
    fs.writeFileSync('./scripts/e_stableSwapScenario/cupcakes/3_positionHandlerAddresses.json', data);
