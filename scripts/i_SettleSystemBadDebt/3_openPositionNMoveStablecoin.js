...
let rawdata = fs.readFileSync('./scripts/i_SettleSystemBadDebt/cupcakes/0_deployment.json');
...
let rawdata2 = fs.readFileSync('./scripts/i_SettleSystemBadDebt/cupcakes/2_proxyWalletAddresses.json');
...
async function main() {
    ...
    await fathomStablecoinAsAlice.approve(proxyWalletAlice, WeiPerWad.div(2));
    ...
    await stablecoinAdapterDeposit(AliceAddress, proxyWalletAsAlice);
    ...
    await moveStablecoin(AliceAddress, systemDebtEngineJSON.address, WeiPerRad.div(2));
